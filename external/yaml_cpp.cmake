...
if(NOT (FDPAPI_FETCH_YAMLCPP_ONLY OR FDPAPI_FETCH_ONLY))
    find_package(yaml-cpp QUIET)
endif()

if(yaml-cpp_FOUND AND NOT (FDPAPI_FETCH_YAMLCPP_ONLY OR FDPAPI_FETCH_ONLY))
    message(STATUS "\tYAML-cpp found.")
elseif(NOT (FDPAPI_FETCH_YAMLCPP_NEVER OR FDPAPI_FETCH_NEVER))
