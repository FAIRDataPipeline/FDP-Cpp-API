...
if(NOT (FDPAPI_FETCH_RE2_ONLY OR FDPAPI_FETCH_ONLY))
    find_package(re2 QUIET)
endif()

if(re2_FOUND AND NOT (FDPAPI_FETCH_RE2_ONLY OR FDPAPI_FETCH_ONLY))
    message(STATUS "\tRE2 found.")
elseif(NOT (FDPAPI_FETCH_RE2_NEVER OR FDPAPI_FETCH_NEVER))
